# Игра Неоновре выживание - Веб-проект

Полнофункциональный одностраничный сайт "Неоновре выживание". Проект включает в себя адаптивный дизайн, интерактивные элементы и систему пользователей.
...
- **Email:** admin@neonsurvival.com/ru
- **Пароль:** admin123
